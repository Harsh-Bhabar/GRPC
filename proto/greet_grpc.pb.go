...
type GreetService_SayHelloClientStreamingClient interface {
	...
	CloseAndRecv() (*MessageListResponse, error)
	grpc.ClientStream
}
...
func (x *greetServiceSayHelloClientStreamingClient) CloseAndRecv() (*MessageListResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(MessageListResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GreetService_SayHelloClientStreamingServer interface {
	SendAndClose(*MessageListResponse) error
	Recv() (*HelloResponse, error)
	grpc.ServerStream
}
...
func (x *greetServiceSayHelloClientStreamingServer) SendAndClose(m *MessageListResponse) error {
	return x.ServerStream.SendMsg(m)
}
